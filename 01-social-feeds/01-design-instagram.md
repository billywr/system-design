...
> **Difficulty:** Hard (feed fan-out + media CDN)  
> **Time budget:** 45 minutes  
> **Primary topics:** Hybrid push/pull fan-out, CDN, stories TTL, sharded counters
...
This guide walks through designing a **photo-sharing social network** at Big Tech interview depth. Follow the Hello Interview pacing: clarify scope early, draw boxes before optimizing, and spend deep-dive time on the **hardest** parts, not on generic CRUD.

**What interviewers optimize for:**

| Rubric pillar | What to demonstrate |
|---|---|
| Problem navigation | Scope feed vs stories vs explore explicitly |
| Solution design | End-to-end post → fan-out → feed read path |
| Technical excellence | Push vs pull fan-out, CDN, counter sharding |
| Communication | Narrate CAP/consistency trade-offs for likes vs posts | |

**Suggested opening script:**

> "I'll design the core Instagram flow: post, follow, home feed, and stories. I'll defer DMs, Reels algorithm details, and shopping unless you want those in scope. My non-functional focus is feed latency at scale and global media delivery."
...
> Spend time on the 2–3 hardest problems specific to Design Instagram — the differentiators.
...
See deep-dive sections and the original guide content for system-specific references to Design Instagram.
