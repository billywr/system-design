...
> **Difficulty:** Hard (FYP + video pipeline)  
> **Time budget:** 45 minutes  
> **Primary topics:** FYP recommendation pipeline, video transcoding, engagement signals
...
This guide walks through designing a **short-form video platform** at Big Tech interview depth. Follow the Hello Interview pacing: clarify scope early, draw boxes before optimizing, and spend deep-dive time on the **hardest** parts, not on generic CRUD.

**What interviewers optimize for:**

| Rubric pillar | What to demonstrate |
|---|---|
| Problem navigation | Scope FYP vs following feed vs upload |
| Solution design | Upload → transcode → index → recommend → serve |
| Technical excellence | Candidate generation, engagement signals, CDN |
| Communication | Cold start and exploration vs exploitation | |

**Suggested opening script:**

> "I'll design TikTok's core loop: upload, transcode, For You Page feed, and engagement. I'll defer live streaming and ads unless in scope. My focus is the recommendation pipeline and video delivery at scale."
...
> Spend time on the 2–3 hardest problems specific to Design TikTok — the differentiators.
...
See deep-dive sections and the original guide content for system-specific references to Design TikTok.
