...
> **Difficulty:** Hard (crawl + index + rank)  
> **Time budget:** 45 minutes  
> **Primary topics:** Crawling, inverted index, PageRank, query serving
...
This guide walks through designing a **web search engine** at Big Tech interview depth. Follow the Hello Interview pacing: clarify scope early, draw boxes before optimizing, and spend deep-dive time on the **hardest** parts, not on generic CRUD.

**What interviewers optimize for:**

| Rubric pillar | What to demonstrate |
|---|---|
| Problem navigation | Scope web search vs autocomplete vs images |
| Solution design | Crawler → indexer → ranker → query server |
| Technical excellence | Inverted index sharding, PageRank, freshness |
| Communication | Crawl politeness and index updates | |

**Suggested opening script:**

> "I'll design Google Search: crawl, index, rank, and serve queries. I'll defer ads and Knowledge Graph unless in scope. My focus is inverted index and sub-100ms query serving."
...
> Spend time on the 2–3 hardest problems specific to Design Google Search — the differentiators.
...
See deep-dive sections and the original guide content for system-specific references to Design Google Search.
